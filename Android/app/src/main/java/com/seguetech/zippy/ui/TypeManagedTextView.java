...
public class TypeManagedTextView extends AppCompatTextView {

    @SuppressWarnings("unused")
    public TypeManagedTextView(Context context) {
        this(context, null);
    }

    @SuppressWarnings("unused")
    public TypeManagedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.textViewStyle);
    }

    @SuppressWarnings("unused")
    public TypeManagedTextView(Context context, AttributeSet attrs, int defStyle) {
