package com.seguetech.zippy.spoon;
...
import static com.seguetech.zippy.spoon.Chmod.chmodPlusR;
import static com.seguetech.zippy.spoon.Chmod.chmodPlusRWX;
...
public final class Fork {
    ...
    private static void takeScreenshot(File file, final Activity activity, Instrumentation instrumentation) throws IOException {
        Bitmap bitmap = null;
        ...
        if (instrumentation != null && Build.VERSION.SDK_INT >= 18) {
            try {
                ...
                // this method just seems to be too fast.
                SystemClock.sleep(96);
